...
- [massa/model/v1/snapshot.proto](#massa_model_v1_snapshot-proto)
    - [CycleSnapshotInfo](#massa-model-v1-CycleSnapshotInfo)
    - [SnapshotRootSignature](#massa-model-v1-SnapshotRootSignature)
...
<a name="massa_model_v1_snapshot-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## massa/model/v1/snapshot.proto



<a name="massa-model-v1-CycleSnapshotInfo"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| cycle | [uint64](#uint64) |  | The cycle number |
| start_ts | [NativeTime](#massa-model-v1-NativeTime) |  | Timestamp when the cycle started |
| end_ts | [NativeTime](#massa-model-v1-NativeTime) |  | Timestamp when the cycle ends |
| merkle_root | [google.protobuf.BytesValue](#google-protobuf-BytesValue) |  | Authenticated snapshot Merkle root for this cycle (absent if not committed) |
| root_signatures | [SnapshotRootSignature](#massa-model-v1-SnapshotRootSignature) | repeated | Signatures over `merkle_root` published for this cycle |
...
<a name="massa-model-v1-SnapshotRootSignature"></a>

### SnapshotRootSignature
Ed25519 signature over a cycle snapshot Merkle root by an authorized signatory.


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| merkle_root | [bytes](#bytes) |  | Merkle root that was signed |
| public_key | [string](#string) |  | Public key of the signatory |
| signature | [bytes](#bytes) |  | Ed25519 signature bytes |
